...
@section('tittle' , 'create new dentist')

@section('main-tittle' , 'create dentist')
...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Create dentist </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form>
             ...
             <div class="row">
                <div class="form-group col-md-4">
                   ...
                   <div class="form-group col-md-4">
                    ...
                    <label for="dentist_name col-md-4">password</label>
