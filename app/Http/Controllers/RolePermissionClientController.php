...
class RolePermissionClientController extends Controller
{
    /**
    ...
    public function index($roleId)
    {
        ...
        return response()->view('cms.spatie.role.rolepermissionclient',['roleId' => $roleId, 'permissions'=>$permissions]);
    }
