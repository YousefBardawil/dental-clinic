...
Route::prefix(LaravelLocalization::setLocale())->middleware(['localeSessionRedirect', 'localizationRedirect'])->group(function () {
    Route::prefix('cms/')->middleware('auth:admin,dentist,client')->group(function(){
        ...
        Route::resource('dashborad', HomeController::class);
        ...
        Route::get('servicestest', [ServiceController::class,'test']);
        ...
        Route::get('notification/markAsRead',[HomeController::class,'markAllRead'])->name('mark.as.read');
        Route::get('notification/Read',[HomeController::class,'readNotification'])->name('read.notifaction');
...
Route::get('dentists',[DentistController::class , 'queue']);
Route::get('sendmails',[DentistController::class , 'sendMail']);
Route::get('/export-rooms',[RoomController::class,'exportToExcel'])->name('export-rooms');
Route::get('/file-import',[RoomController::class,'importView'])->name('import-view');
Route::post('/import',[RoomController::class,'import'])->name('import');
Route::get('open-pdf-file', [PDFController::class, 'index']);
Route::get('create-pdf-file', [PDFController::class, 'downloadPdf'])->name('download.pdf');
